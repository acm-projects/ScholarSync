...
export default function ProfessorsPage() {
  ...
  const profUrl = "https://tzupgr575f.execute-api.us-east-2.amazonaws.com/dev/professors"
  useEffect(() => {
  ...
  const dataset = useMemo(() => {
    if (tab === "recommended") {
      return profRecommended ? normalizeAllItems(profRecommended, userTags) : [];
    }
    return profAll ? normalizeAllItems(profAll, userTags) : [];
  }, [tab, profAll, profRecommended, userTags]);
