...
export default function OpportunityCard({ item, userTags, showPct = true, theme = "base", href }) {
  ...
  return (
    <div
      ...
      onKeyDown={(e) => (e.key === "Enter" && href ? router.push(href) : null)}
      className={`h-48 w-full overflow-hidden rounded-2xl p-5 shadow-md flex flex-col transition-all duration-200 ${cardStyle} focus:outline-none focus:ring-2 focus:ring-[#BA3F3D]`}
